  ...
  return (
    ...
    <section className='head'>
      ...
      <section className='bod2'style={{display:'flex', justifyContent:'center',}}>
        <div style={{textAlign:'center', width:'50%',  flexDirection:'column'}}>
        <h1 style={{margin:'20px'}}>Visi & Misi</h1>
        ...
        <div style={{textAlign:'justify',display:'flex', justifyContent:'center', margin:'20px'}}>
        <ol>
      ...
      <section className='bod3'>
        <div>
          <h1 style={{margin:'60px 0px'}}>Keunggulan</h1>
        ...
        <div style={{display:'flex',justifyItems:'center', alignItems:'center', textAlign:'justify', marginTop:'120px', marginRight:'20px', marginLeft:'20px'}}>
          <div style={{display:'flex'}}>
            <img src="tlogo.png" alt="tlogo" style={{width: '118px', height:'127px'}}/>
          ...
          <div style={{display:'flex'}}>
            <img src="tlogo2.png" alt="tlogo" style={{width: '118px', height:'127px'}}/>
            <div style={{margin:'20px',width:'50%'}}><h4>PARABEN FREE</h4>
            <span className='desic'>Komposisi produk yang kami jual bebas dari paraben untuk merawat kulit anda dengan aman dan efektif.</span></div>
          </div>
          <div style={{display:'flex'}}>
            <img src="tlogo3.png" alt="tlogo" style={{width: '118px', height:'127px'}}/>
            <div style={{margin:'20px',width:'50%'}}><h4>PARABEN FREE</h4>
            <span className='desic'>Komposisi produk yang kami jual bebas dari paraben untuk merawat kulit anda dengan aman dan efektif.</span></div>
          </div>
        </div>
